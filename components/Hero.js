    ...
    return (
        <section className={styles.hero}>
            <div className={styles.content}>
                ...
                <button id="random-button" className="btn shadow-md hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring focus:ring-red-300 ">Random Video</button>
            </div>
        </section>
    )
